...
import { Program } from "../../src/compute/program";
...
export class Video {
  private compute: hex.ComputeContext
  private program: hex.Program
  private output:  hex.Color2D
  private start:   number

  constructor(private context: WebGL2RenderingContext, public width: number, public height: number) {
  ...
  public get(): Uint8Array {
    const delta = (Date.now() - this.start) * 0.001
